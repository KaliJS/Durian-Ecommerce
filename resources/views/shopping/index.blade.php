...
@section('content')
    ...
    <section id="home-section" class="hero">
	      ...
	      <div class="slider-item" style="background-image: url({{url('uploads/banners/'.$slide[0]->image)}});">
	      ...
	      <div class="slider-item" style="background-image: url({{url('uploads/banners/'.$slide[1]->image)}});">
	      	<div class="overlay"></div>
	        <div class="container">
	          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
    ...
    <section class="ftco-section">
		...
		<section class="ftco-section img" style="background-image: url({{url('uploads/banners/'.$home->image)}});">
    	<div class="container">
